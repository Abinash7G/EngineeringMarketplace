...
//       const token = localStorage.getItem('access_token');
//       await axios.patch(
//         `http://127.0.0.1:8000/api/appointments/${appointmentId}/update-status/`,
//         { status: newStatus },
//         { headers: { Authorization: `Bearer ${token}` } }
//       );
//       // Refresh inquiries after updating status
//       fetchInquiries();
//     } catch (err) {
...
//                                 color="warning"
//                                 size="small"
//                                 onClick={() => updateAppointmentStatus(inquiry.appointment.id, 'No-Show')}
//                               >
//                                 Mark as No-Show
//                               </Button>
//                               <Button
...
//                                 color="success"
//                                 size="small"
//                                 onClick={() => updateAppointmentStatus(inquiry.appointment.id, 'Completed')}
//                               >
//                                 Mark as Completed
//                               </Button>
//                             </>
